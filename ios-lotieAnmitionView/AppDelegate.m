...
- (void)applicationWillEnterForeground:(UIApplication *)application {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"anmition" object:nil];
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"ios_lotieAnmitionView"];
